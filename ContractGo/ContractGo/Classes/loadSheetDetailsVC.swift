...
class loadSheetDetailsVC: UIViewController, UITableViewDelegate , UITableViewDataSource {
...
extension loadSheetDetailsVC : UICollectionViewDataSource , UICollectionViewDelegate , UICollectionViewDelegateFlowLayout{
